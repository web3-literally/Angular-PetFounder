...
@Component({
    selector: 'app-register-foundpet',
    templateUrl: './register-foundpet.component.html',
    styleUrls: ['./register-foundpet.component.scss']
})
export class RegisterFoundPetComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.submitForm = this.fb.group({
            details: this.fb.group({
                ...
                dateFound: [null, Validators.required],
                desc: null,
    ...
    public postFoundPet() {
        const petInfo = {
            ...
            dateFound: this.submitForm.value.details.dateFound,
        ...
        this.petService.registerFoundPet(petInfo).subscribe(reply => {
            try {
                if (reply.data.status == 'success') {
                    this.snackBar.open('Founded Pet Registered Successfully!', '×', {
                        panelClass: 'success',
                    ...
                    this.snackBar.open('Founded Pet Register Failed!', '×', {
                        panelClass: 'failed',
                        verticalPosition: 'top',
                        duration: 3000
                    });
                ...
                this.snackBar.open('Founded Pet Register Failed!', '×', {panelClass: 'failed', verticalPosition: 'top', duration: 3000});
            }
        });
    }
